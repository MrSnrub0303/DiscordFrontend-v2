...
function LevelCard({ campaignId, actId, level, playHoverSound, playClickSound }) {
  ...
  return (
    ...
    >
      {/* Base image — clipped by lvlcard_mask via CSS mask-image */}
      <div
      ...
      {/* Title plate — centred at bottom using titlebg (1120×90) as background */}
